...
if (__cBill_debug !== undefined) {
    ...
    function __cBill_click(theWidget) {
        __cBill_logger('__cBill_click : simulating Click...');
        ...
        __cBill_logger('__cBill_click : Click event dispatched...');
    }
    ...
    var __cBill_connectionsServer = 'https://social.ibmcollabcloud.com';
}
